...
// 1) Property image shows only the media with ord === 1
// 2) View button navigates to /admin/listings/view/:category/:id
// 3) User card places profile image at top like property image, details below
// 4) Modal improved with orange theme
                        ...
                        <div className="mt-1 flex flex-grow items-end justify-between"> 
                            ...
                            <div className="flex gap-2">
                                <button 
                                    ...
                                    className={`px-3 py-2 ml-2 rounded text-sm font-medium transition-colors border ${lead.enquiryStatus==='ASSIGNED' ? 'bg-gray-200 text-gray-600 border-gray-200' : 'bg-green-500 hover:bg-green-600 border-green-500 text-white'}`}>
                                ...
                                <button 
                                    ...
                                    className={`px-3 py-2 ml-2 rounded text-sm font-medium transition-colors border ${lead.enquiryStatus==='REMOVED' ? 'bg-gray-200 text-gray-600 border-gray-200' : 'bg-red-500 hover:bg-red-600 border-red-500 text-white'}`}>
                                    Remove
                                </button>
                            </div>
                        </div>
