...
const AgentNotifications: React.FC = () => {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      const [allResp, countResp] = await Promise.all([
        ...
        api.get<NotificationDetails[]>("/agent/allNotificationsForAgent"),
        api.get<number>("/agent/getUnreadNotificationCountForAgent"),
      ]);
  ...
  const markNotificationViewed = async (id: number) => {
    ...
    try {
      ...
      await api.patch(`/agent/markNotificationViewedForAgent/${id}`);
    } catch (e) {
  ...
  const markAllAsRead = async () => {
    ...
    try {
      ...
      // );
      await api.patch("/agent/markAllNotificationViewedForAgent");
    } catch (e) {
